...
VehicleRoutingTransportCostsMatrix.Builder costMatrixBuilder = VehicleRoutingTransportCostsMatrix.Builder.newInstance(true);costMatrixBuilder.addTransportDistance("0", "1", 74.8777);
costMatrixBuilder.addTransportDistance("0", "2", 63.647);
costMatrixBuilder.addTransportDistance("0", "3", 28.6605);
costMatrixBuilder.addTransportDistance("0", "4", 97.23960000000001);
costMatrixBuilder.addTransportDistance("0", "5", 43.342800000000004);
costMatrixBuilder.addTransportDistance("1", "2", 137.656);
costMatrixBuilder.addTransportDistance("1", "3", 67.7997);
costMatrixBuilder.addTransportDistance("1", "4", 27.718400000000003);
costMatrixBuilder.addTransportDistance("1", "5", 117.3517);
costMatrixBuilder.addTransportDistance("2", "3", 90.73389999999999);
costMatrixBuilder.addTransportDistance("2", "4", 84.5929);
costMatrixBuilder.addTransportDistance("2", "5", 52.7708);
costMatrixBuilder.addTransportDistance("3", "4", 56.827);
costMatrixBuilder.addTransportDistance("3", "5", 70.3208);
costMatrixBuilder.addTransportDistance("4", "5", 57.1961);
